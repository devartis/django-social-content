...
class Content(PolymorphicModel):
    ...
    identifier = models.CharField(max_length=2500, verbose_name=_('identifier'), blank=False, null=True)

    text = models.TextField(max_length=2500, verbose_name=_('text'), blank=True, null=True)
    ...
    image_url = models.URLField(max_length=2500, blank=True, null=True, verbose_name=_('image URL'))
...
class TwitterContent(Content):
    ...
    video_url = models.URLField(max_length=2500, blank=True, null=True, verbose_name=_('video URL'))
...
class YoutubeContent(Content):
    ...
    title = models.CharField(max_length=2500, verbose_name=_('title'))
